...
public class IpodUSBSlot extends Item {
	
	public IpodUSBSlot() {
		super(IdData.iPodUSBSlot);
		this.setCreativeTab(Main.tabIpod);
		this.setUnlocalizedName(UnlocalizedData.iPodUSBSlot);
	}
	
	@SideOnly(Side.CLIENT)
	public void registerIcons(IconRegister iconR) {
		this.itemIcon = iconR.registerIcon("ipodmod:ipod_usb");
	}
