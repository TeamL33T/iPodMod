...
public class IpodMemCard extends Item {

	public IpodMemCard() {
		super(IdData.iPodMemCard);
		this.setCreativeTab(Main.tabIpod);
		this.setUnlocalizedName(UnlocalizedData.iPodMemCard);
	}
	
	@SideOnly(Side.CLIENT)
	public void registerIcons(IconRegister iconR) {
		this.itemIcon = iconR.registerIcon("ipodmod:ipod_memcard");
	}
