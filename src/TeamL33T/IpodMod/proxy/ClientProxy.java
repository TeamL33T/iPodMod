...
import TeamL33T.IpodMod.entity.EntityIpodHacker;
import TeamL33T.IpodMod.model.ModelAppleDealer;
import TeamL33T.IpodMod.model.ModelIpodHacker;
import TeamL33T.IpodMod.render.RenderAppleDealer;
import TeamL33T.IpodMod.render.RenderIpodHacker;
...
public class ClientProxy extends CommonProxy {
	...
	public void registerRenderHandlers() {
		...
		RenderingRegistry.registerEntityRenderingHandler(EntityIpodHacker.class, new RenderIpodHacker(new ModelIpodHacker(), 0.5F));
	}
	...
	public void registerItems() {
		...
		GameRegistry.registerItem(Main.iPodClassic, UnlocalizedData.iPodClassic);
	...
	public void registerEntities() {
		// Apple Dealer
		EntityRegistry.registerGlobalEntityID(EntityAppleDealer.class, UnlocalizedData.AppleDealer, EntityRegistry.findGlobalUniqueEntityId(), 0x000066, 0x0000CC);
		// iPod Hacker
		EntityRegistry.registerGlobalEntityID(EntityIpodHacker.class, UnlocalizedData.iPodHacker, EntityRegistry.findGlobalUniqueEntityId(), 0x000000, 0x33FF33);
	}
	...
	public void registerLocals() {
		...
		LanguageRegistry.addName(Main.iPodClassic, LocalizedData.iPodClassic);
		...
		LanguageRegistry.instance().addStringLocalization("entity."+UnlocalizedData.iPodHacker+".name", LocalizedData.iPodHacker);
	}

	@Override
	public void registerMisc() {
		NetworkRegistry.instance().registerGuiHandler(Main.instance, Main.guiHandler);
	}
